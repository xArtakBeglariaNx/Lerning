...
namespace OOP_step_93_DynamicTypes_ExportDataToOfficeApp
{
    class Program
    {
        static void Main(string[] args)
        {
            List<Car> carIsStock = new List<Car>()
            {
                new Car(){Color = "Green", Make = "VM", PetName = "Mery"},
            ...
            //ExportToExel(carIsStock);
            //ExportToExcelManual(carIsStock);
            Console.ReadLine();
        }

        static void ExportToExel(List<Car> carInStock)
        {
            ...
            excelApp.Quit();
            Console.WriteLine("The Inventory.xlsx file has been saved in your app folder");
        }
